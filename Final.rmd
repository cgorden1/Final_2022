...
Ffish
```
The inferential test shows us that there is a 95% confidence level and that interval is 0.60 for the placebo. 0.92 for the vaccines interval and the odds ratio is 0.7e the p value = 0.005 
